...
The accessibility domain itself is grounded in public standards and open tools, cited
throughout the doctrine: **WCAG 2.2 / 2.1** (W3C), **EN 301 549** and the **European
Accessibility Act**, **ADA Title III**; and the engines **axe-core** (Deque), **pa11y**,
**Lighthouse**, and **guidepup** (for driving real screen readers). None of those are
affiliated with this project; they are the instruments, credited where used.
